...
const TaskCard = ({ title, description, priority, status, progress, createdAt, dueDate, assignedTo, attachmentCount, completedActCount, actChecklist, onClick }) => {
  ...
  return (
    ...
    >
        ...
        >
            <p className="text-sm font-medium text-gray-800 line-clamp-2 mt-4">
                {title}
            </p>
            ...
            <p className='text-[13px] text-gray-700/80 font-medium mt-2 mb-2 leading-4.5'>
                ...
                <span className="font-semibold text-gray-700">
                    {completedActCount}/{actChecklist.length || 0}
                </span>
            </p>
